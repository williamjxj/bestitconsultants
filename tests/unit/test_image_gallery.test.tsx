 ...
 * Tests component functionality, layout variations, and animations
 */
...
describe('ImageGallery', () => {
  ...
  describe('Basic rendering', () => {
    ...
    it('should render with default layout (grid)', () => {
      ...
      const gallery = screen.getByAltText('Test image 1').closest('div')
  ...
  describe('Layout types', () => {
    it('should handle grid layout', () => {
      render(<ImageGallery images={mockImages} layout='grid' />)
