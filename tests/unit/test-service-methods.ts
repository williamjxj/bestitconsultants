  ...
  describe('ImageService', () => {
    describe('getImage', () => {
      ...
      it('should fallback to cache when R2 fails', async () => {
        // Mock R2 failure
        jest.spyOn(r2Client, 'getObject').mockRejectedValue(new Error('R2 unavailable'));
  ...
  describe('ImageMigrationService', () => {
    describe('migrateAllImages', () => {
      it('should migrate all images successfully', async () => {
        ...
        jest.spyOn(migrationService, 'migrateAllImages').mockResolvedValue(mockStatus);
    ...
    describe('verifyMigration', () => {
      it('should verify migration status', async () => {
        ...
        jest.spyOn(migrationService, 'verifyMigration').mockResolvedValue(mockVerification);
