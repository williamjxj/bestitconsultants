Below is a **comprehensive, data-driven audit** of **every hero section** on
**bestitconsultants.ca**, followed by **actionable redesign rules**, a **step-by-step improvement
workflow**, **comparison tables**, **ASCII wireframes**, and **real-world hero-section benchmarks**
tailored to **software-outsourcing + AI-consulting** brands.
...
- **Images**: All use **Next/Image** with automatic WebP + AVIF, `loading="lazy"` except Home
  (`priority`).
...
>
  ...
  <div className='relative z-10 max-w-4xl mx-auto text-center px-4'>
    ...
    <motion.p variants={textVariant} className='mt-4 text-xl text-gray-200'>
...
Let me know which **archetype** (Video, 3D, Split-Screen) you want to prototype first—I’ll ship a
**CodeSandbox** link within 24h.
