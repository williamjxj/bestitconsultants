...
## Shared Components
-   **`HeroSection`**: Created a versatile, reusable component supporting various layouts (center, split, left), dynamic backgrounds, and content slots.
...
-   **Case Studies, Team, Portfolio, Testimonials**: Standardized all these pages to use the new `HeroSection` component with consistent branding and gradients.
