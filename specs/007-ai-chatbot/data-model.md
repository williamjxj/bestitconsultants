...
This document defines the data structures and entities for the AI chatbot feature. The chatbot uses
browser sessionStorage for persistence and does not require server-side data storage.
