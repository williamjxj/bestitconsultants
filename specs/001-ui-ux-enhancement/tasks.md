...
- [ ] T009 [P] Contract test POST /api/scrape/ai-news in tests/contract/test_web_scraping_api.test.ts
- [ ] T010 [P] Integration test navigation menu functionality in tests/integration/test_navigation.test.ts
- [ ] T011 [P] Integration test testimonials footer display in tests/integration/test_testimonials.test.ts
...
- [ ] T037 [P] Update Navbar component with simplified navigation in src/components/common/Navbar.tsx
