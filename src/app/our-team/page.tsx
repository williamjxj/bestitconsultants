...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: 'Leads sales and marketing to extend BestIT\'s business reach. Senior Business Development professional with nearly 8 years driving high-ticket consultative sales in EdTech and travel. Closed $70K (AED 257K) in a single month (Jan 2026); $750K+ career revenue including $238K+ at BYJU\'S. Skilled in complex sales cycles, senior stakeholder engagement, and advising technology professionals across 14 engineering domains. Focus: international market expansion and revenue growth for BestIT.',
    expertise: [
      'High-ticket consultative selling (discovery, objection handling)',
      'International market expansion & strategic growth',
      'Key account management & pricing strategy',
      'Sales enablement, coaching & onboarding',
      'Revenue optimization & yield management',
      'Sales tech & AI prompt engineering',
    ],
    achievements: [
      'Closed $70K (AED 257K) peak monthly revenue in Jan 2026; $90K in first 60 days at Interview Kickstart.',
      'Generated $750K+ career revenue; $238K+ at BYJU\'S with 30% conversion rate.',
      'Top Referral Consultant at upGrad (Q4 2023, Q1 2024); generated $300K (₹2.5 Cr) at upGrad.',
      'Launched and scaled Finance vertical as founding team member at Hero Vired; coached new hires on consultative selling.',
      'Certified: Generative AI Prompt Engineering (Microsoft & upGrad 2025), Key Account Management (LinkedIn 2025).',
    ],
    specializations: [
    ...
    education:
      'BA in English, University of Delhi (2021). Certifications: Generative AI Prompt Engineering (Microsoft & upGrad 2025), Key Account Management (LinkedIn 2025).',
    prestigeProjects: [
      {
        ...
        type: 'company',
        description:
          'Advised senior technology professionals across 14 engineering domains through discovery-led, consultative selling. Converted high-ticket program opportunities ($7K–$10K average).',
        outcome: '$70K peak monthly revenue (Jan 2026); $90K total in first 60 days.',
        technologies: ['Consultative Sales', 'High-Ticket Closing', 'CRM', 'Pipeline Management'],
        year: 2026,
      },
      {
        id: 'byjus-revenue',
        name: 'Senior Business Development Associate, BYJU\'S',
        type: 'company',
        description: 'Generated $238K+ revenue while sustaining 30% conversion rate. Trained 4 new associates, contributing to 20% improvement in team performance.',
        outcome: 'Proven high-ticket EdTech sales and team enablement.',
        technologies: ['B2B Sales', 'Team Training', 'Conversion Optimization'],
        year: 2022,
      },
    ],
  },
