  ...
  en: {
    ...
    testimonials: {
      ...
      industries: {
        ...
        list: [
          { icon: 'Landmark', name: 'Finance & Banking', projects: 25 },
          { icon: 'Heart', name: 'Healthcare', projects: 18 },
          { icon: 'ShoppingCart', name: 'E-Commerce', projects: 32 },
          { icon: 'GraduationCap', name: 'Education', projects: 15 },
          { icon: 'Factory', name: 'Manufacturing', projects: 12 },
          { icon: 'Car', name: 'Automotive', projects: 8 },
          { icon: 'Hotel', name: 'Hospitality', projects: 10 },
          { icon: 'Cpu', name: 'Technology', projects: 40 },
        ],
      },
      cta: {
