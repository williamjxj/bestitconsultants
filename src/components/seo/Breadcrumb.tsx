 ...
 * @param hideVisual - If true, only renders structured data (no visual breadcrumb)
 */
export default function Breadcrumb({
  items,
  className,
  hideVisual = false,
}: BreadcrumbProps & { hideVisual?: boolean }) {
  // Generate BreadcrumbList structured data
  const breadcrumbSchema = createBreadcrumbSchema(items)

  return (
    <>
      {/* BreadcrumbList structured data (JSON-LD) - Always included for SEO */}
      <script
